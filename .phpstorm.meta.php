...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\Asus\assignment-submission-system\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\Users\\Asus\\assignment-submission-system\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'password.update','logout','dashboard','admin.dashboard','teacher.dashboard',
'student.dashboard','assignments.index','assignments.create','assignments.store','assignments.show',
'assignments.edit','assignments.update','assignments.destroy','courses.index','courses.create',
'courses.store','courses.show','courses.edit','courses.update','courses.destroy',
'enrollments.index','enrollments.create','enrollments.store','enrollments.destroy','student.my-courses',
'student.submissions.index','student.submissions.create','student.submissions.store','student.grades.my-grades','student.feedback.my-feedback',
...
'admin.roles.show','admin.roles.edit','admin.roles.update','admin.roles.destroy','admin.reports.index',
'admin.reports.submissions','admin.reports.grades','admin.reports.performance','admin.reports.destroy','teacher.grades.by-assignment',
'teacher.grades.edit','teacher.grades.update','teacher.feedbacks.index','teacher.feedbacks.store','notifications.index',
'notifications.mark-read','notifications.mark-all-read','notifications.destroy','profile.index','profile.update',
'profile.password','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'assignments.create','assignments.edit','assignments.index','assignments.show','auth.confirm-password',
'auth.forgot-password','auth.login','auth.passwords.confirm','auth.passwords.email','auth.passwords.reset',
'auth.register','auth.reset-password','auth.verify','auth.verify-email','components.application-logo',
...
'components.secondary-button','components.text-input','courses.create','courses.edit','courses.index',
'courses.show','dashboard','enrollments.create','enrollments.edit','enrollments.index',
'enrollments.show','feedbacks.create','feedbacks.edit','feedbacks.index','feedbacks.show',
'grades.create','grades.edit','grades.index','grades.show','home',
'layouts.app','layouts.guest','layouts.navigation','notifications.index','profile.edit',
'profile.index','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','reports.create',
'reports.index','reports.show','roles.create','roles.edit','roles.index',
'roles.show','submission-history.index','submission-history.show','submissions.create','submissions.edit',
'submissions.index','submissions.show','users.create','users.edit','users.index',
'users.show','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
...
'C:.Users.Asus.assignment-submission-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'QUEUE_CONNECTION','SESSION_DRIVER','SESSION_LIFETIME','SESSION_DOMAIN','REDIS_HOST',
